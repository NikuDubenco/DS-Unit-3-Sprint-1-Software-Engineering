...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
    ...
    """ In general for code reviews is important that the developer write a
      readable code, for himself later and also for other colleagues who
      will use his part of code. In python is a good practice to follow the
      PEP8 convention. An important part is writing commits inside the code.
      Describe with docstrings the classes, functions, modules, what they do,
      their purposes and scopes. Also do commits for blocks of code inside the
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  improve this situation?
    ...
    """ Containers is an abstracted and virtualized enviroment or system that 
      contains programs that need to run an application. The containers are 
      independent from hardware and operating system it runs on. Containers 
      help to run code reliably and reproducibly, so it runs identically in
      any kind of machine or host."""
